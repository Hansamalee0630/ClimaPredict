...
//                 unit="ppm"
//               />
//               <HistoryChart thresholds={thresholds}
//                 history={history}
//                 forecast={forecast}
//                 keyName="co2"
...
//             <HistoryChart thresholds={thresholds} history={history} forecast={forecast} keyName="temperature" title="Temperature Forecast (°C)" />
//             <HistoryChart thresholds={thresholds} history={history} forecast={forecast} keyName="humidity"    title="Humidity Forecast (%)" />
//           </div>
//           <div style={{ marginTop: 20 }}>
//             <HistoryChart thresholds={thresholds} history={history} forecast={forecast} keyName="co2" title="CO₂ Forecast Overview (ppm)" />
//           </div>
//         </div>
//       )}
//     </div>
